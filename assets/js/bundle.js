...
var RoomPane = (function (_React$Component) {
  ...
  function RoomPane() {
    ...
    _get(Object.getPrototypeOf(RoomPane.prototype), 'constructor', this).call(this);
  }
...
_reactAddons2['default'].render(_reactAddons2['default'].createElement(_main2['default'], null), document.getElementById('main'));

},{"./main":3,"react/addons":4}],3:[function(require,module,exports){
'use strict';
...
var _reactRoomPane = require('../react/RoomPane');

var _reactRoomPane2 = _interopRequireDefault(_reactRoomPane);
